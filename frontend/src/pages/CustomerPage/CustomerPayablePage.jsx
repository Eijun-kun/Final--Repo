                                    ...
                                    <tr key={item.productId._id}>
                                        <td>
                                            ...
                                            src={item.productId?.imageUrl
                                                ? `https://sabon-depot-frontend.vercel.app/${item.productId.imageUrl}`
                                        ...
                                        <td>
                                            {
                                                ...
                                                <img
                                                src={`https://sabon-depot-frontend.vercel.app/${order.paymentProof}`}
                    ...
                    <div className='modal-content'>
                        <h2>{selectedOrder.paymentStatus === 'Paid' ? 'Proof of Payment' : 'Proof of Payment'}</h2>
                        {
                            selectedOrder.paymentStatus === 'Paid' && (
                                <img src={`https://sabon-depot-frontend.vercel.app/${selectedOrder.paymentProof}`} alt='Proof' className='modal-proof-image' />
                            )
                        }
                        {
