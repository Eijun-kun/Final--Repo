...
import '../../../CSS/AdminCSS/AdminInventory/WorkinProgress.css'
...
import AdminModalWorkinProgressProductAddComponent from '../../../components/AdminComponents/AdminModalWorkinProgressProduct/AdminModalWorkinProgressProductAddComponent';
import AdminModalWorkinProgressProductDeleteComponent from '../../../components/AdminComponents/AdminModalWorkinProgressProduct/AdminModalWorkinProgressProductDeleteComponent';
import AdminModalWorkinProgressProductEditComponent from '../../../components/AdminComponents/AdminModalWorkinProgressProduct/AdminModalWorkinProgressProductEditComponent';


function AdminWorkinProgressPage() {
    ...
    useEffect(() => {
        const fetchSummaryData = async() => {
            try {
                const response = await axios.get('/adminWorkinProgressProduct/getWorkinProgressProductSummaryAdmin');
    ...
    const handleEditProductClick = async(productId) => {
        try {
            const response = await axios.get(`/adminWorkinProgressProduct/getEditWorkinProgressProductAdmin/${productId}`);
    ...
    const handleConfirmDelete = async() => {
        try {
            const response = await axios.delete(`/adminWorkinProgressProduct/deleteWorkinProgressProductAdmin/${productIdToDelete}`);
    ...
    const fetchProducts = async() => {
        try {
            const response = await axios.get('/adminWorkinProgressProduct/getWorkinProgressProductAdmin');
  ...
  return (
    <div className='admin-finished-product-container'>
        <AdminModalWorkinProgressProductAddComponent
        isOpen={isModalOpen} 
        onClose={handleCloseModal}
        fetchProducts={fetchProducts}
        />

        <AdminModalWorkinProgressProductDeleteComponent
        isOpen={isDeleteModalOpen} 
        onClose={handleCloseDeleteModal} 
        onConfirm={handleConfirmDelete} 
        />

        <AdminModalWorkinProgressProductEditComponent
                            ...
                            products.map((product) => (
                                ...
                                >
                                    ...
                                    <td className='product-image-name'>
                                        <img src={`https://sabon-depot-frontend.vercel.app/${product.imageUrl}`} alt={product.productName} />{' '}{product.productName}
                                    </td>
...
export default AdminWorkinProgressPage